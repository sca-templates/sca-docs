...
> A request to send a notification to a user; produced by any service, consumed by `sca-notifications`.
...
| Service | When | Notes |
|---|---|---|
| [[sca-auth]] | account lifecycle (welcome, password reset, safe-mode alert) | |
...
|---|---|---|
| [[sca-notifications]] | renders and sends through the provider (MailHog local / SES prod) | dedupe by `correlation_id` |
